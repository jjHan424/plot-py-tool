...
path_aug_I = "/Volumes/SAMSUNG USB/NUC/server/HKPC-C-S.aug"
path_aug_S = "/Volumes/SAMSUNG USB/NUC/server/HKPC-GEC-S.aug"
figP,axP = plt.subplots(figsize=(19,10),sharey=False,sharex=True)
#Time
time="UTC"
starttime=0
year = 2021
...
###-------------AUG-GEC--------------###
[head_I,data_I] = rf.open_aug_file_new(path_aug_S)
...
for i in range(100):
    ...
    if C:
        axP.scatter(time_C[0],data_C[0],s=1)
font2 = {'family' : 'Arial',
            'weight' : 600,
            'size'   : 25,
                }
axP.set_ylabel("ZTD(m)",font2)
axP.set_xticks(XTick)
axP.set_xticklabels(XLabel,fontsize=25)
# axP[2].set_yticklabels([-0.2,-0.1,0,0.1,0.2],fontsize="x-large")
axP.set_ylim(2.40,2.60)
axP.set_yticks([2.400,2.425,2.450,2.475,2.500,2.525,2.550,2.575,2.600])
axP.set_yticklabels(["2.400","2.425","2.450","2.475","2.500","2.525","2.550","2.575","2.600"],fontsize=20)
# axP.set_title("GEC",font2)
axP.set_xlabel("UTC",font2)
axP.grid(False)
axP.grid(False)
axP.grid(False)
