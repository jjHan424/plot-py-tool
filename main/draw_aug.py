...
path_S = r"E:\1Master_2\Paper_Grid\Res_FromServer_New\Server\2021312\HKSC-GEC.aug"   # PPPAR算的改正数
path_I = r"E:\1Master_2\Paper_Grid\Res_FromServer_New\Client\client-Aug-312\HKSC-GEC-I.aug"# 内插改正数
...
dr.plot_aug_GEC_new(data,head_I,type = "ION",freq = 1,starttime = 10,time = "UTC+8",show = True,deltaT=2,ylim=0.2,LastT=14,year = 2021,mon=11,day=8)
#########
