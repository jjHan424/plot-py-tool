...
LastEditTime: 2022-03-29 11:35:37
...
mode_list = ["HKTK","HKSC","HKLM"]#,"4 Sites Grid","3 Sites MLCM"]
#site_list = ["HKLM","HKSC","HKTK"]
site_list = ["HKTK","HKSC","HKLM"]
filename_list = ["/Users/hjj/Documents/HJJ/Master_1/IonoGrid/2021100/client/HKTK-GEC-ion.flt",
...
dr.plot_enu(data = ENU_ALL,type = ["E","N","U"],mode = mode_list,ylim = 0.2,starttime=2,begT=11,LastT=5,deltaT=1,time = "UTC+8",Fixed=True,delta_data = 30)
