...
while count > 0:
    ...
    for i in range(len(site_list)):
        ...
        diff_dir = "/Users/hanjunjie/Downloads/HKMW-GEC2-30.diff"
        ...
        path_roti = '/Users/hanjunjie/Downloads/HKMW2021305_GEC.ismr'
        ###-------------ROTI-------------###
        ...
        for time in Diff_Data.keys():
            ...
            if (plot_time > begT and plot_time < begT + LastT) or all:
                ...
                for sat in Diff_Data[time].keys():
                    ...
                    prn = int(sat[1:3])
                    if sat[0] == "C":
                        data_C[prn-1].append(abs(Diff_Data[time][sat]["dION1"]))
                        temp_mean_C.append(abs(Diff_Data[time][sat]["dION1"]))
                        time_C[prn-1].append(plot_time)
                    if sat[0] == "G":
