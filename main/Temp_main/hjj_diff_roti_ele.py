...
axP.set_xlim(0,2)
axP.set_ylim(0,0.2)
axP.set_xlabel("ROTI(TECU/min)",font)
...
axP.set_ylabel("Ionospheric errors(m)",font)
...
plt.savefig(r"E:\1Master_2\Paper_Grid\1-Paper_word\Image-1\Errors-Roti-Polynomial.svg")
plt.show()
...
# axP.set_xlim(5,75)
# axP.set_xlabel("Elevation(deg)",font)
...
# plt.savefig(r"E:\1Master_2\Paper_Grid\1-Paper_word\Image-1\Errors-Ele-Polynomial.svg")
# plt.show()