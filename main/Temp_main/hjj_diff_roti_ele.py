...
# filename = r"G:\Data\Fig\Ele_Wgt-New\Roti.txt"
# Diff,Roti = [],[]
...
# axP.scatter(Roti,Diff,s=15,c="black")
# x=np.linspace(0.95,1.75,1000)
# y=abc[0]*x*x + abc[1]*x + abc[2]
# axP.plot(x,y,linewidth=4.0,linestyle='--')
...
# axP.set_xticklabels(["0.25","0.50","0.75","1.00","1.25","1.50","1.75","2.00"],fontsize=18)
# axP.set_ylabel("Ionospheric errors(m)",font_label)
# axP.set_yticks([0.000,0.025,0.050,0.075,0.100,0.125,0.150,0.175,0.200])
# axP.set_yticklabels(["0","0.025","0.050","0.075","0.100","0.125","0.150","0.175","0.200"],fontsize=18)
# labels = axP.get_yticklabels() + axP.get_xticklabels()
# [label.set_fontsize(xtick_size) for label in labels]
# [label.set_fontname('Times New Roman') for label in labels]
# # plt.savefig(r"D:\A-paper\Fig_and_Res\Errors-Roti-Polynomial.svg")
# # plt.savefig(r"D:\A-paper\Fig_and_Res\Errors-Roti-Polynomial.png",dpi=600)
# plt.show()

#Diff-Ele
filename = r"G:\Data\Fig\Ele_Wgt-New\diff-meanele.txt"
Diff,Ele = [],[]
...
axP.scatter(Ele,Diff,s=15,c="black")
...
axP.set_xticklabels(["5","15","25","35","45","55","65","75"],fontsize=18)
axP.set_ylabel("Ionospheric errors(m)",font_label)
axP.set_yticks([0.000,0.005,0.010,0.015,0.020,0.025,0.030])
axP.set_yticklabels(["0.000","0.005","0.010","0.015","0.020","0.025","0.030"],fontsize=18)
labels = axP.get_yticklabels() + axP.get_xticklabels()
[label.set_fontsize(xtick_size) for label in labels]
[label.set_fontname('Times New Roman') for label in labels]
plt.savefig(r"D:\A-paper\Fig_and_Res\Errors-Ele-Polynomial.svg")
plt.savefig(r"D:\A-paper\Fig_and_Res\Errors-Ele-Polynomial.png",dpi=600)
plt.show()