...
count = 1
# grid_diff_file = "/Users/hanjunjie/Master_3/1-IUGG/AUG2GRID/2021279/GREAT-GEC2-30-0822.grid"
## 331 ##
# plt.subplot(3,3,1)
# # box = ax.get_position()
...
# grid_diff_file = "/Users/hanjunjie/Master_3/LX/GREAT-GEC2-30-0822.grid"
# grid_diff_file = "/Users/hanjunjie/Master_3/LX/GREAT-GEC2-30-0822.grid"
# sec = sec + Delta
# if sec >= 60:
#     min = min + sec/60
...
# map.pcolormesh(x, y, data_diff, cmap='jet', zorder=0,vmin = 0,vmax = 2)
...
cp = plt.colorbar(cax=cbax,shrink=2,format = "%.0f",ticks = [0,0.5,1,1.5,2],pad = 0.1,orientation = "horizontal")
cp.set_label('IONO errors (cm)',fontdict = font_label)
cp.set_ticklabels((0,0.5,1,1.5,2),fontsize = 25)
# plt.tight_layout()
