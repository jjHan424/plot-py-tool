...
import draw as dr
import trans as tr
Year,Mon,Day,Hour,lastT,DeltaT = 2021,11,1,2,10,2
count = 100
...
while count > 0:
    for cur_site in site_list1:
        for cur_delay in delay_list:
            ...
            dr.plot_aug_G_E_C_Test(data_site[cur_site],head_I,type = "dION1",freq = 1,starttime = Hour,time = "UTC",show = False,ylim=0.2,deltaT=DeltaT,LastT=lastT,year = Year,mon=Mon,day=Day,data_S=data_res,min_ele = Min_ele,max_ele = Max_ele,Site = cur_site,Mode = "OLD_DAY",Sun = "ALL")
